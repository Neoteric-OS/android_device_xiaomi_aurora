...
class SuppressionRect {
    ...
    override fun toString(): String {
        val listString = list.joinToString(prefix = "[", postfix = "]")
        return "SuppressionRect{list=$listString, type=$type, position=$position, topLeftX=$topLeftX, topLeftY=$topLeftY, bottomRightX=$bottomRightX, bottomRightY=$bottomRightY, time=0, node=0}"
    }
}
