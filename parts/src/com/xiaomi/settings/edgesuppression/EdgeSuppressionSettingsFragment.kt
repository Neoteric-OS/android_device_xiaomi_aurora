...
class EdgeSuppressionSettingsFragment :
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        val appContext = activity?.applicationContext ?: context?.applicationContext
        if (appContext == null) {
            Log.e(TAG, "Unable to initialize edge suppression: context is null")
            return
        }
        edgeSuppressionManager = EdgeSuppressionManager.getInstance(appContext)
